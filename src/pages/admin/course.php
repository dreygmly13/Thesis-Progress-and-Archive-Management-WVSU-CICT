...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <?php include("../components/course-list.php"); ?>
            </div>
          </div>
        </div>
      </section>
  ...
  <script>
    ...
    function handleSave(el) {
      ...
      swal.showLoading();
      $.post(
        "../../backend/nodes?action=saveCourse",
        formValue,
        (data, status) => {
    ...
    function handleOnclickDeleteCourse(courseId) {
      swal.fire({
        title: 'Are you sure',
        icon: 'question',
        html: `you want to delete this course?`,
        showDenyButton: true,
        ...
        if (res.isConfirmed) {
          swal.showLoading();
          $.post(
            "../../backend/nodes?action=deleteCourse", {
              id: courseId
            },
            (data, status) => {
              const resp = JSON.parse(data)
